...
-- null의 값을 치환해주는 함수 : nvl(원본데이터, null 일 때 치환되는 값)
...
select *
from emp
where ename = 'SCOTT';  -- 저장된 문자열은 대소문자를 구분
...
select *
from emp
where ename like 'F%';  -- F, Fasdfasdf
